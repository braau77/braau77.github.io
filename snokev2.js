...
var vw = 500; //sets var vw as entire sceen width
var vh = 500; //sets var vh as entire screen height
var fRate = 10;
var food;
var eat;
...
function Snake(){ //Snake Constructor function
  ...
  if (d < 1){
    ...
    document.getElementById('showScore').innerHTML = "Score: " + this.total;
    eat.soundVolume(1.0);
    eat.play();
    return true;
  }
  ...
  this.death =  function(){
    if ((this.x > vw - scl) || (this.x < 0) || (this.y > vh - scl) || (this.y < 0)){
      this.tail = [];
      this.total = 0;
      document.getElementById('showScore').innerHTML = "Dakine is dead braddah";
      noLoop();
    }
